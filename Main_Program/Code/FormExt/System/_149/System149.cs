...
namespace HuDongHeavyMachinery.Code.FormExt.System._149
{
    public class System149 : SwBaseForm
    {
        private readonly object[] loactionInts = { 0, "" };
        private DBDataSource OQUT, QUT1;
        ...
        public override void FormCreate(string formUId, ref ItemEvent pVal, ref bool bubbleEvent)
        {
            ...
            OQUT = MyForm.DataSources.DBDataSources.Item("OQUT");
            QUT1 = MyForm.DataSources.DBDataSources.Item("QUT1");
        }
